...
public class GenreDbStorage implements GenreStorage {
    ...
    private static final String FIND_ALL_GENRES_SQL = """
            SELECT * FROM genres
            """;
    private static final String FIND_GENRE_BY_ID_SQL = """
            SELECT * FROM genres WHERE genre_id = ?
            """;
    private static final String FIND_ALL_GENRES_BY_FILM_SQL = """
            SELECT *
            FROM GENRES g,
                 film_genres fg
    ...
    public List<Genre> findAllGenres() {
        String sql = FIND_ALL_GENRES_SQL;
        return jdbcTemplate.query(sql, (rs, rowNum) -> makeGenre(rs));
    }

    @Override
    public Optional<Genre> findGenreById(int id) {
        String sql = FIND_GENRE_BY_ID_SQL;
    ...
    public void findAllGenresByFilm(List<Film> films) {
        ...
        String sql = FIND_ALL_GENRES_BY_FILM_SQL;
